 ...
 */
public class InsertSortWithoutGeneric {
    ...
    public static void main(String[] args) {
        InsertSortWithoutGeneric insertSortWithoutGeneric = new InsertSortWithoutGeneric();
        int[] array = {9, 9, 7, 7, 8, 4, 7, 3, 6, 6, 1, 3, 1, 4, 1, 5, 9, 2, 6, 5,
                2, 5, 3, 5, 4, 9, 6, 10, 11, 19,
            0, -1, 34, 22, 17, 14, 9, 66, 96, 86, 22, 47, 74, 48};
        insertSortWithoutGeneric.sort(array);
    }
